...
;
-- We found null in below given columns
-- year: 20
...
-- Count of movies produced by USA or India for the last year 2019 is 1059
...
-- Drama genre had the highest movies produced overall (4285).
...
-- Thriller genre has 3rd rank with 1,484 movies
...
-- Dream Warrior Pictures and National Theatre Live production both have the most number of hit movies
-- i.e, 3 movies with average rating > 8
...
--  There are 14 movies that start with the word ‘The’ and which have an average rating > 8.
-- title        avg_rating      genre
...
GROUP BY median_rating;
-- There are 361 movies that released between 1 April 2018 and 1 April 2019 and were given a median rating 8
...
-- Germany has 1,06,710 and italy has 77,965 votes
...
--  Vijay Sethupathi, Fahadh Faasil and Yogi Babu are top 3 actors in given order
...
-- Taapsee Pannu, Kriti Sanon, Divya datta, Shraddha Kapoor, Kriti Kharbanda are the top five actresses in Hindi movies released in India based on their average ratings
...
-- Parvathy Thiruvothu, Susan Brown and Amanda Lawrence are the top 3 actresses giving most Super Hit movies (average rating >8) in drama genre
